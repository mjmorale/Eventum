...
public class SwipeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mEventList.add(new Event("OSS-117 Movie watching",
                ...
                new Date(2021, 1, 16), "Satellite, EPFL", new LatLng(46.520553, 6.567821), R.drawable.oss_117));
        mEventList.add(new Event("Duck themed party",
                ...
                new Date(2020, 3, 7), "Satellite, EPFL", new LatLng(46.520553, 6.567821), R.drawable.duck));
        mEventList.add(new Event("Make Internet great again",
                ...
                new Date(2020, 4, 20), "Satellite, EPFL", new LatLng(46.520553, 6.567821), R.drawable.frog));
        mEventList.add(new Event("Real Fake Party",
                "This is really happening",
                new Date(2020, 11, 10), "Satellite, EPFL", new LatLng(46.520553, 6.567821)));
