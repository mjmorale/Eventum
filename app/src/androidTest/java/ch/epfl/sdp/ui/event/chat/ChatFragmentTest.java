...
public class ChatFragmentTest {
    ...
    public void setup() {
        ...
        when(mCollectionQueryMock.create(any())).thenReturn(new Future<>(mStringTask));

        when(mFirebaseAuthenticatorMock.getCurrentUserInfo()).thenReturn(new UserInfo(mChatMessage.getUid(), " ", " "));
    ...
    public void ChatFragment_Test_Sender() {
        ...
        when(mFirebaseAuthenticatorMock.getCurrentUserInfo()).thenReturn(new UserInfo("newRef", " ", " "));
